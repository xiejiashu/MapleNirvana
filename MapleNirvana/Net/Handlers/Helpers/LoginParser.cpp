...
namespace ms
{
	...
	CharEntry LoginParser::parse_charentry(InPacket& recv)
	{
		...
		// int64_t pet1 = recv.read_long();
		// int64_t pet2 = recv.read_long();
		// int64_t pet3 = recv.read_long();
	...
	StatsEntry LoginParser::parse_stats(InPacket& recv)
	{
		...
		statsentry.stats[MapleStat::Id::LEVEL] = static_cast<short>(recv.read_byte());
		...
		if (statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN  ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN1 || 
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN2 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN3 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN4 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN5 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN6 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN7 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN8 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN9 ||
			statsentry.stats[MapleStat::Id::JOB] == ms::CashShopParser::Jobs::EVAN10)
		{
			// TODO: Handle Evan SP parsing properly
			char effectiveLength = recv.read_byte();
		...
		statsentry.stats[MapleStat::Id::FAME] = recv.read_short(); // fame

		recv.skip(4); // gachaexp	// Gacha Exp

		statsentry.mapid = recv.read_int();	// mapid
		statsentry.portal = recv.read_byte();	// spawnpoint
